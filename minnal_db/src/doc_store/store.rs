...
use crate::{AsyncDb, DbConfig, ExtractorFn, FieldId, IndexValue, IndexValueType, RowIdFn, RowToKeyFn};
use log::{debug, info};
#[cfg(feature = "semantic-search")]
use log::{error, warn};
...
use crate::doc_store::schema::{DocStoreSchema, IndexSpec, IndexType, KeyType, KvStoreSchema, SchemaAmendment, StoreType};
#[cfg(feature = "semantic-search")]
...
fn index_type_to_attr_type(t: IndexType) -> crate::doc_store::schema::AttributeType {
    match t {
